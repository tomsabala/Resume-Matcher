...
Open **<http://localhost:3030>** and configure your AI provider in Settings.
...
Run on a single public port (`3030`) with API available at `/api`:
...
- API health check: <http://localhost:3030/api/v1/health>
