  ...
  return (
    ...
    >
      <div className="mx-auto flex min-h-0 w-full max-w-[104rem] flex-1 flex-col">
        <Link
          href="/dashboard"
          className="mb-3 hidden shrink-0 items-center gap-1 self-start font-mono text-xs uppercase text-ink-soft hover:text-primary lg:inline-flex"
        >
          <ArrowLeft className="h-3.5 w-3.5" />
          {t('nav.backToDashboard')}
        </Link>
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-background lg:border lg:border-black lg:shadow-sw-lg">
          <KanbanBoard />
        </div>
      </div>
    </main>
